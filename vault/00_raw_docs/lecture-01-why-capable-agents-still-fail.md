---
id: 202605241200-lecture-01-why-capable-agents-still-fail
aliases:
  - "Lecture 01 - Tại sao các Agent mạnh vẫn thất bại"
date: 2026-05-24
type: inbox-note
summary: "Phân tích nguyên nhân tại sao các AI Agent cực kỳ mạnh mẽ (như Claude 3.5 Sonnet) vẫn thất bại trong các tác vụ thực tế."
...
## Nguồn tài liệu
- **URL**: [https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-01-why-capable-agents-still-fail/](https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-01-why-capable-agents-still-fail/)
...
Ví dụ mã nguồn: [code/](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/vi/lectures/lecture-01-why-capable-agents-still-fail/code/) Dự án thực hành: [Dự án 01. Chỉ Prompt vs. Ưu tiên Quy tắc](./../../projects/project-01-baseline-vs-minimal-harness/)
...
`AGENTS.md`
`pytest tests/api/v2/ && python -m mypy src/`
