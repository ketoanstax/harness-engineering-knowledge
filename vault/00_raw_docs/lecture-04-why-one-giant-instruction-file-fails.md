---
id: 202605241200-lecture-04-why-one-giant-instruction-file-fails
aliases:
  - "Lecture 04 - Tại sao một file hướng dẫn khổng lồ lại thất bại"
date: 2026-05-24
type: inbox-note
summary: "Phân tích bẫy thiết kế khi dồn tất cả các luật vào một file chỉ dẫn khổng lồ (như CLAUDE.md quá tải) và cách giải quyết bằng phân mảnh tri thức."
...
## Nguồn tài liệu
- **URL**: [https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-04-why-one-giant-instruction-file-fails/](https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-04-why-one-giant-instruction-file-fails/)
...
Ví dụ mã nguồn: [code/](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/vi/lectures/lecture-04-why-one-giant-instruction-file-fails/code/) Dự án thực hành: [Dự án 02. Không gian làm việc Agent đọc được](./../../projects/project-02-agent-readable-workspace/)
