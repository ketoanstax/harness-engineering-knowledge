---
id: HAE-concept-du-luu
title: "Dự lưu (Sotāpanna)"
...
- Người dự lưu có đức tin bất động vào Tam bảo và giới hạnh viên mãn.
- Con đường dự lưu bắt đầu bằng chánh kiến về Tứ Thánh Đế.

## 🔗 Mạng lưới Nhân Duyên Quả (Causal Web)
- **Nhân gốc (Causal Core)**: Không có — Khái niệm nền tảng sinh ra khái niệm này.
- **Hội tụ Duyên (Supporting Conditions)**: [Gioi Hanh](02_atomic_nodes/HAE-concept-gioi-hanh.md), [Thien Dinh](02_atomic_nodes/HAE-concept-thien-dinh.md) — Các khái niệm hỗ trợ trực tiếp.
- **Quả chuyển hóa (Derivative Effects)**: [Nhat Lai](02_atomic_nodes/HAE-concept-nhat-lai.md) — Các giải pháp và hiệu quả kế thừa.
