...
# Thư mục Vault trung tâm
DIR_VAULT = os.path.join(VAULT_ROOT, "vault")

# Các thư mục phân lớp trong Vault
DIR_RAW = os.path.join(DIR_VAULT, "00_raw_docs")
DIR_STRUCTURED = os.path.join(DIR_VAULT, "01_structured_docs")
DIR_ATOMIC = os.path.join(DIR_VAULT, "02_atomic_nodes")
DIR_NEURAL_MAP = os.path.join(DIR_VAULT, "03_neural_map")
DIR_DISTILLED = os.path.join(DIR_VAULT, "04_distilled")
DIR_JOURNAL = os.path.join(DIR_VAULT, "05_journal")
...
PATH_FEEDBACK = os.path.join(DIR_VAULT, "memory", "feedback_log.md")
...
for d in [DIR_VAULT, DIR_RAW, DIR_STRUCTURED, DIR_ATOMIC, DIR_NEURAL_MAP, DIR_DISTILLED, DIR_JOURNAL]:
