---
id: 202605241200-lecture-07-why-agents-overreach-and-under-finish
aliases:
  - "Lecture 07 - Tại sao Agent làm quá giới hạn và chưa hoàn thành"
date: 2026-05-24
type: inbox-note
summary: "Cách khống chế hành vi tự ý sửa đổi tràn lan ngoài phạm vi (overreach) và tình trạng để lại code dang dở (under-finish) của Agent."
...
## Nguồn tài liệu
- **URL**: [https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-07-why-agents-overreach-and-under-finish/](https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-07-why-agents-overreach-and-under-finish/)
...
Ví dụ mã nguồn: [code/](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/vi/lectures/lecture-07-why-agents-overreach-and-under-finish/code/) Dự án thực hành: [Dự án 04. Phản hồi Runtime và Kiểm soát Phạm vi](./../../projects/project-04-incremental-indexing/)
