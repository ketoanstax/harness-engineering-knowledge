---
id: 202605241200-lecture-03-why-the-repository-must-become-the-system-of-record
aliases:
  - "Lecture 03 - Tại sao Repository phải trở thành Nguồn sự thật"
date: 2026-05-24
type: inbox-note
summary: "Lý giải tại sao toàn bộ lịch sử, cấu trúc và tri thức dự án phải nằm trực tiếp trong Git Repository của dự án."
...
## Nguồn tài liệu
- **URL**: [https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-03-why-the-repository-must-become-the-system-of-record/](https://walkinglabs.github.io/learn-harness-engineering/vi/lectures/lecture-03-why-the-repository-must-become-the-system-of-record/)
...
Ví dụ mã nguồn: [code/](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/vi/lectures/lecture-03-why-the-repository-must-become-the-system-of-record/code/) Dự án thực hành: [Dự án 02. Không gian làm việc Agent đọc được](./../../projects/project-02-agent-readable-workspace/)
